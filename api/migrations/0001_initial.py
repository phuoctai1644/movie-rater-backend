# Generated by Django 5.0.3 on 2024-05-09 17:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(blank=True, validators=[django.core.validators.MinValueValidator(1900)])),
                ('thumbnail', models.ImageField(blank=True, null=True, upload_to=api.models.get_upload_path)),
                ('type', models.CharField(blank=True, max_length=128)),
                ('trailer_url', models.CharField(blank=True, max_length=512)),
            ],
        ),
        migrations.CreateModel(
            name='User',
